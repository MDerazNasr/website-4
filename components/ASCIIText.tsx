...
class CanvAscii {
  ...
  constructor(
    ...
    this.camera = new (THREE as any).PerspectiveCamera(45, this.width / this.height, 1, 1000);
  ...
  setMesh() {
    ...
    this.texture = new (THREE as any).CanvasTexture(this.textCanvas.texture);
    ...
    this.geometry = new (THREE as any).PlaneGeometry(planeW, planeH, 36, 36);
  ...
  setRenderer() {
    this.renderer = new (THREE as any).WebGLRenderer({ antialias: false, alpha: true });
  ...
  clear() {
    this.scene.traverse((object: any) => {
      const obj = (object as any) as THREE.Mesh;
